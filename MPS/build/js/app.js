        ...
        (function(r, s, o, a, l, u, h, d, g) {
            ...
            AnalyserView = function(e) {
                ...
                if (!this.freqByteData || this.freqByteData.length != this.analyser.frequencyBinCount) {
                    ...
                    }, !1), gridResponse = new Float32Array(256), freqByteData = new Uint8Array(this.analyser.frequencyBinCount), this.freqByteData = freqByteData, this.texture && (e.deleteTexture(this.texture), this.texture = null);
                ...
                switch (freqByteData = this.freqByteData, this.analysisType) {
                    ...
                    case b:
                        ...
                        //var all = [4,5,6,20,21,22,23,36,37,38,39,52,53,54,55,68,69,70,71,72,84,85,86,87,99,100,101,102,115,116,117,127,132,133,143,147,149,150,165,181,196];
                        // The electrodes to include
                        var all = [2,3,4,5,6,7,8,13,14,16,18,19,20,21,22,23,24,25,32,35,36,37,38,39,41,42,46,48,49,51,52,53,54,55,56,59,60,61,62,65,66,67,68,69,70,71,72,76,82,83,84,85,86,87,89,98,99,100,101,102,110,111,114,115,116,117,118,126,127,128,130,131,132,133,134,143,146,147,148,149,150,151,163,164,165,166,169,179,180,181,195,196,197,210,211,212,226,227,228,248,249,250]

                        selectedCategory = all;
                        selectedScaling = 0.04;
                        selectedScaling = 0.1;
                        this.analyser.smoothingTimeConstant = 0.02;
                        //this.analyser.smoothingTimeConstant = 2.0;
    ...
    9: [function(e, t, n) {
        (function(n, r, i, s, o, a, l, u, h) {
            function f() {
                ...
                e.fftSize = 2048, e.smoothingTimeConstant = 0;
            ...
            var f = e("../util/util.js"),
                ...
                g = {
                    ...
                    onResize_: function() {
                        ...
                        var e = $("#spectrogram")[0];
                        g.canvas = e, e.width = Math.max($(window).width(),800), e.height = 800;//$(window).height();
                        /*var t = $("#legend")[0];
                        t.width = $(window).width(), t.height = 320, g.drawLegend_();//t.height = $(window).height() - 158, g.drawLegend_();
                        */
                        var brain = $("#content")[0];
                        brain.width = Math.max($(window).width(), 800), brain.height = Math.min($(window).height()*0.6, 600);  
